...
if [ ! -f "$APP_DIR/.env" ]; then
    ...
    cat > $APP_DIR/.env << EOL
TOKEN_SECRET=${TOKEN_SECRET:-"6a5370759d0587fd3601315ab0f6da8402c2fbb80cc43fca0bbb3c62ac0a51ad"}
ORACLE_REGION=${ORACLE_REGION:-"us-phoenix-1"}
ORACLE_COMPARTMENT_ID=${ORACLE_COMPARTMENT_ID:-"ocid1.tenancy.oc1..aaaaaaaagmlqkvkg6l7cv64yp4l3nk5mnkwg4akjwmhbglus7xz6fhhtno6q"}

# MongoDB Configuration
MONGODB_URI=mongodb://introhater_admin:g7K9xP3zR5vT8mF2@localhost:27017/introHater?authSource=admin
...
EOL
    ...
    if ! grep -q "MONGODB_URI" "$APP_DIR/.env"; then
        ...
        echo "MONGODB_URI=mongodb://introhater_admin:g7K9xP3zR5vT8mF2@localhost:27017/introHater?authSource=admin" >> $APP_DIR/.env
    fi
fi
